...
FEATURES = {
    ...
    'SOCIAL_SHARING_SETTINGS': {
        ...
        'CERTIFICATE_FACEBOOK_TEXT': True,
...
TIME_ZONE = 'Europe/Budapest'  # http://en.wikipedia.org/wiki/List_of_tz_zones_by_name
LANGUAGE_CODE = 'hu'  # http://www.i18nguy.com/unicode/language-identifiers.html
